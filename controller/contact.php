...
if(isset($_POST['action']) and $_POST['action']=='send_message' and !empty($_POST['name']) and !empty($_POST['email']) and !empty($_POST['message']) and (isset($_POST['captcha']) or isset($_POST['recaptcha_response'])) and isset($_POST['rules'])){
