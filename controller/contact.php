...
if(isset($_POST['action']) and $_POST['action']=='send_message' and !empty($_POST['name']) and !empty($_POST['email']) and !empty($_POST['message']) and (isset($_POST['captcha']) or isset($_POST['g-recaptcha-response'])) and isset($_POST['rules'])){
	...
	if(isset($error)){
		...
		if(mail::send('contact_form',$settings['email'],['name'=>$_POST['name'], 'email'=>$_POST['email'], 'message'=>strip_tags($_POST['message'])])){
